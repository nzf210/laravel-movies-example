...
<template>
    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img :src="props.data.actor.profile_path" :alt="props.data.actor.profile_path" class="w-76">
                <ul class="flex items-center mt-4">
                        <li v-if="props.data.social.facebook">
                            <a :href="props.data.social.facebook" title="Facebook"  target="_blank">
                        ...
                        <li class="ml-6"  v-if="props.data.social.instagram">
                            <a :href="props.data.social.instagram" title="Instagram" target="_blank">
                        ...
                        <li class="ml-6" v-if="props.data.social.twitter">
                            <a :href="props.data.social.twitter" title="Twitter" target="_blank">
                        ...
                        <li class="ml-6"  v-if="props.data.social.homepage">
                            <a :href="props.data.actor.homepage" title="Website" target="_blank">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 md:mt-0 font-semibold">{{ props.data.actor.name }}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2">{{ props.data.actor.birthday }} ({{ props.data.actor.age}} years old) in {{ props.data.actor.place_of_birth }}</span>
                </div>

                <p class="text-gray-300 mt-8">
                    {{ props.data.actor.biography }}
                </p>

                <h4 class="font-semibold mt-12">Known For</h4>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                        <div class="mt-4" v-for="movie in props.data.knownForMovies">
                            <Link :href="movie.linkToPage"><img :src="movie.poster_path" :alt="movie.title" class="hover:opacity-75 transition ease-in-out duration-150"></Link>
                            <Link :href="movie.linkToPage" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">{{ movie.title }}</Link>
                        </div>
                </div>
            </div>
        </div>
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                    <li v-for="credit in props.data.credits">
                        {{ credit.release_year }} &middot;
                        <strong><Link :href="credit.linkToPage" class="hover:underline">{{ credit.title}}</Link></strong>
                          {{ credit.character }}
                     </li>
            </ul>
        </div>
